...
public class ThreadScan{
	...
	public   JFrame main=new JFrame("JAVA端口扫描器");
	
	//显示扫描结果
	public   JTextArea Result=new JTextArea("",4,40);
	//滚动条面板
	public   JScrollPane resultPane = new JScrollPane(Result,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
	JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
	
	
	//输入主机名文本框
	public   JTextField hostname=new JTextField("localhost",8);
	
	//输入ip地址前3位的输入框
	public   JTextField fromip1=new JTextField("0",3);
	//输入ip地址4~6位的输入框
	public   JTextField fromip2=new JTextField("0",3);
	//输入ip地址7~9位的输入框
	public   JTextField fromip3=new JTextField("0",3);
	//输入起始ip地址最后4位的输入框
	public   JTextField fromip4=new JTextField("0",3);
	//输入目标ip地址最后4位的输入框
	public   JTextField toip=new JTextField("0",3);
	
	//输入最小端口的输入框
	public   JTextField minPort=new JTextField("0",4);
	//输入最大端口的输入框
	public   JTextField maxPort=new JTextField("1000",4);
	//输入最大线程数量的输入框
	public   JTextField maxThread=new JTextField("100",3);
	
	//错误提示框
	public   JDialog DLGError=new JDialog(main,"错误!");
	public   JLabel DLGINFO=new JLabel("");
	
	public   JLabel type=new JLabel("请选择：");
	
	//扫描类型
	public   JRadioButton radioIp = new JRadioButton("IP地址：");
	public   JRadioButton radioHost = new JRadioButton("主机名：",true);
	//单选框组
	public   ButtonGroup group = new ButtonGroup();

	public   JLabel P1=new JLabel("端口范围:");
	public   JLabel P2=new JLabel("~");
	public   JLabel P3=new JLabel("~");
	public   JLabel Pdot1 = new JLabel(".");
	public   JLabel Pdot2 = new JLabel(".");
	public   JLabel Pdot3 = new JLabel(".");
	public   JLabel TNUM=new JLabel("线程数:");
	public   JLabel RST=new JLabel("扫描结果:                                       ");
	public   JLabel con=new JLabel("                                                                                                              ");

	//定义按钮
	public   JButton OK = new JButton("确定");
	public   JButton Submit = new JButton("开始扫描");
	public   JButton Cancel = new JButton("退出");
	public   JButton saveButton = new JButton("保存扫描结果");

	//菜单栏
	public   JMenuBar myBar = new JMenuBar();
	public   JMenu myMenu = new JMenu("文件(F)");
	public   JMenuItem saveItem = new JMenuItem("保存扫描结果(S)");
	public   JMenuItem exitItem = new JMenuItem("退出(Q)");
	public   JMenu myMenu2 = new JMenu("帮助");
	public   JMenuItem helpItem = new JMenuItem("阅读");
